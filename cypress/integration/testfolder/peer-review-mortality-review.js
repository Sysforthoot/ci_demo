...
describe('Peer review', function(){
    it('Peer review Frontend',function(){
        ...
        cy.wait(2000);
        cy.get('#reviewNumber').type(keyword);
        // cy.wait('@reviewNumber');
        cy.xpath("(//input[@id='reviewTitle'])").type(keyword,{delay: 0});
        // cy.wait(2000);
        cy.get('#peerReviewDescription').type(keyword,{delay: 0});
        // cy.wait(2000);
        cy.clock();
        cy.tick(5000);
        cy.get('.react-datepicker__input-container > .text-lg',{timeout:6000}).click().type('{enter}',{delay:0});
        // cy.wait(1000);
        // cy.tick();
        // cy.get('.react-datepicker__day--003').click();
        // cy.contains('1').click();
        // cy.wait(2000);
        // cy.wait('@id=peerReviewDescription');
        cy.get('#mortalityIncident',{timeout:4000}).type(keyword,{delay: 0});
        // cy.wait(2000);
        // cy.clock();
        
        cy.contains('Select...',{timeout:4000}).type('{enter}',{delay:0});
        // // cy.wait(2000);
        cy.clock().invoke('restore');
        // cy.get('#requestedExpertDescription',{timeout:6000}).type(keyword,{delay: 0});
        // // cy.wait(2000);
        cy.get('#reviewConflictDescription',{timeout:6000}).type(keyword,{delay: 0});
        // cy.wait(2000);
        // cy.get('#hospitalName',{timeout:6000}).type(keyword,{delay: 0});
        // cy.wait(2000);
        // cy.get('#hospitalZipCode',{timeout:6000}).type("74859",{delay: 0});
        // cy.wait(2000);
        // cy.get('#internalNotes',{timeout:6000}).type(keyword),{delay: 0}; 
        // cy.wait(2000);
    ...
    //llgin to cc for close out case 
      ...
      // cy.wait(2000);
      cy.get('.react-datepicker__day--012').click(); //selct date
      cy.wait(2000);
