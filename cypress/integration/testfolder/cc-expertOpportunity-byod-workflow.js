...
describe('cc-app-test 1', () => {
    ...
    it("open the hoot medplus login page 1",()=>{
      ...
      cy.visit("https://hoot-web-staging.herokuapp.com/");  
         ...
         cy.wait(2000);
         cy.get('.checkbox > .svg-inline--fa').click();
         cy.wait(1000);
        //  cy.wait(2000);
  ...
  it("medical expert side",()=>{
      ...
      cy.wait(3000);
      cy.get('#peerReviewInviteAcceptButton').click(); // accept case
      cy.wait(3000);
      cy.get('#confirmationModalConfirmationButton').click(); // confirmation of acceptance
      cy.wait(30000);
