describe('cc-app-test 1', () => {
    ...
    it("open the hoot medplus login page 1",()=>{
      ...
      cy.get("#firstName").type("Test_ME");
        ...
        cy.wait(2000);
        cy.get("#emailAddress").type("sysforthoot6@gmail.com");
        cy.wait(2000);
        cy.get("#password").type("Sysforth4@2022");
        cy.wait(2000);
        cy.get("#passwordConfirmation").type("Sysforth4@2022");
        cy.wait(2000);
        ...
        cy.wait(2000);
        cy.xpath('/html[1]/body[1]/div[1]/main[1]/div[1]/div[1]/form[1]/div[2]/div[2]/div[2]/label[1]/input[1]').type('123456789');
        cy.wait(2000);
