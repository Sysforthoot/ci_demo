...
cy.wait(2000);
cy.get('#confirmationModalConfirmationButton').click(); // confirmtaion of decline case
cy.wait(2000);
cy.get(':nth-child(1) > .flex > .radio-container > .selector').click(); // reason for decline
cy.wait(2000);
cy.get('.btn').click(); // submit the cancel
cy.wait(5000); 
